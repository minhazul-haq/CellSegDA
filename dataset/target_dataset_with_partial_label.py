...
class TargetPartialLabelledDataSet(data.Dataset):
    def __init__(self, root_dir, image_folder='train_images', mask_folder='train_masks', max_iters=None,
        ...
        dataset = (root_dir.split('/')[-1]).split('_')[0]
    ...
    def __getitem__(self, index):
        ...
        return image, mask_exists, mask, datafiles["name"]
