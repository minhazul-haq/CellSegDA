...
# labelled target dataset loader
...
class TargetLabelledDataSet(data.Dataset):
    def __init__(self, root_dir, image_folder='validation_images', mask_folder='validation_masks', max_iters=None,
